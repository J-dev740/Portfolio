  ...
  return <section className='section' id='about' ref={ref}>
    <div className='container mx-auto'>
      <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 h-screen'>
        ...
        className='flex-1 flex bg-about bg-contain bg-no-repeat h-[600px] mix-blend-lighten bg-middle mt-20'>
          </motion.div>
        {/* text */}
        <motion.div variants={fadeIn('left',0.5)} initial='hidden' whileInView={'show'} viewport={{once:false,amount:0.3}}
         className='flex-1'>
          <h2 className='h2 text-accent'> About me.</h2>
          <h3 className='h3 mb-4'> I'm a Freelancer Developer and an Explorer with over 1 years of
            experience.
          </h3>
          <p className='mb-6'>
            Lorem ipsum dolor sit, amet consectetur adipisiciing elit.
             Dolor natus omnis inventoze quas beatae illo nulla. Officills
             magniomnius 
            molestias
          </p>
